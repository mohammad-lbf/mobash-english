                ...
                <div className="container pb-3 pb-lg-0">
                    <div className="row align-items-center justify-content-center">
                        ...
                        <div className="col-12 col-lg-6 d-flex align-items-center flex-column align-items-lg-end ">
                                <p style={{direction:"rtl"}} className="border-bottom border-danger text-center text-lg-end fs-3 fw-bold">
                                    همه مارو به صفحه ی Youtube می‌شناسن
                                </p>
                                <p
                                style={{
                                    direction:"rtl",
                                ...
                                style={{width:"148px"}}
                                className=''>
                                    <a rel="noreferrer" href="https://youtube.com/@MobashEnglish" style={{direction:"rtl"}} className="fs-5 ">
                                    <NeonButton name="صفحه یوتیوب ما" clickHandler={()=>{}} />
                                    </a>
                                </div>
